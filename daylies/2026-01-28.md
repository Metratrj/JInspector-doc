...
Diese ist anscheinend "quasi Industriestandard" - erhält Verwendung in OpenJDK, dem Groovy und Kotlin Kompiler, Cobertura und Jacoco, Byte Buddy, Mockito sowie in Gradle. Man könnte quasi sagen Java Basiert auf dieser Libary.
...
Um hier auch nicht mit der Zeit zu gehen würde ich tatsächlich hier auf die JavaFX Libary setzen. Diese war mal Bestandteil von der JDK aber seit Version 8 - *ich glaube aber weiß nicht genau* nicht mehr. Vorteile hier ist die native Unterstützung von CSS, hat eingebaute Charts, ein reiches Plugin-Ecosystem, ist flexibler im Layout. 
